...
public class SampleHostedService(ILogger<SampleHostedService> logger, IOptionsSnapshot<EngineSettings> options) : IHostedService, IDisposable
{
    private readonly ILogger<SampleHostedService> _logger = logger;
    private readonly EngineSettings _options = options.Value;
